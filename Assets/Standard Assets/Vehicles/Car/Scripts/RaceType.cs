    ...
    void Update()
    {
        if (SaveScript.RaceOver == true)
        {
            if (TimeTrial == true)
            {
                ...
                if (SaveScript.RaceTimeMinutes == GoldMinutes && (SaveScript.RaceTimeSeconds + SaveScript.PenaltySeconds) <
GoldSeconds)
                {
                    Debug.Log("Gold");
                    SaveScript.Gold = true;
                ...
                if (SaveScript.RaceTimeMinutes == SilverMinutes && (SaveScript.RaceTimeSeconds + SaveScript.PenaltySeconds) <
SilverSeconds)
                {
                    if (SaveScript.Gold == false)
                    {
